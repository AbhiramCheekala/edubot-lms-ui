...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:tw-border-b","tw-bg-custom_yellow tw-font-bold ", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "tw-border-b tw-transition-colors data-[state=selected]:tw-bg-muted",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "tw-h-12 tw-px-4 tw-text-left tw-align-middle tw-font-bold tw-text-gray-950 [&:has([role=checkbox])]:tw-pr-0",
      className
    )}
    {...props}
  />
