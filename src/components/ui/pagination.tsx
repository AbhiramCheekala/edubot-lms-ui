...
const PaginationLink = ({
  ...
  <Button
    ...
    size={size}
    className={cn("disabled:tw-pointer-events-auto disabled:tw-cursor-not-allowed disabled:tw-text-gray-400 hover:disabled:tw-bg-inherit hover:disabled:tw-text-gray-400", className)}
    disabled={disabled}
    {...props}
  />
)
...
const PaginationPrevious = ({
  ...
  <PaginationLink
    ...
    size="default"
    className={cn("tw-gap-1 tw-pl-2.5 tw-cursor-pointer", className)}
    {...props}
  >
...
const PaginationNext = ({
  ...
  <PaginationLink
    ...
    size="default"
    className={cn("tw-gap-1 tw-pr-2.5 tw-cursor-pointer", className)}
    {...props}
  >
    <span>Next</span>
